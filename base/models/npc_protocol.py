from typing import TYPE_CHECKING, Any, Iterable, Optional, Protocol, Sequence, Union
...
class NPCProtocol(Protocol):
    ...
    base_strength: 'Any'
    base_constitution: 'Any'
    base_dexterity: 'Any'
    base_intelligence: 'Any'
    base_wisdom: 'Any'
    base_charisma: 'Any'
    ...
    def adelete(self, using=..., keep_parents=...): ...
    def arefresh_from_db(self, using=..., fields=..., from_queryset=...): ...
    def asave(
        self, args, force_insert=..., force_update=..., using=..., update_fields=...
    ): ...
    ...
    def get_sex_display(self, field=...): ...
    ...
    def refresh_from_db(self, using=..., fields=..., from_queryset=...): ...
    def save(
        self, args, force_insert=..., force_update=..., using=..., update_fields=...
    ): ...
    def save_base(
