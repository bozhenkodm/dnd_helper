from base.objects import npc_classes, weapon_types
...
weapon_types_tuple = (
    ...
    weapon_types.Dagger,
    weapon_types.DoubleAxe,
    weapon_types.DoubleAxeSecondEnd,
    weapon_types.DoubleFlail,
    weapon_types.DoubleFlailSecondEnd,
    weapon_types.DoubleSword,
    weapon_types.DoubleSwordSecondEnd,
    ...
    weapon_types.Urgrosh,
    weapon_types.UrgroshSecondEnd,
